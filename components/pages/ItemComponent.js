  ...
  render() {
    return (
      <View style={styles.eventsList}>
        ...
        <TouchableHighlight onPress ={() => this.state.navigation.navigate('Event', {event})} style= {{height: 70, width: 365, backgroundColor:'white', borderRadius: 28, shadowRadius: 3, shadowOpacity:0.3, shadowOffset: {width: 1, height: 0}, shadowColor: '#000000', elevation: 4,}}>
